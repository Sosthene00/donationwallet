...
pub(crate) const FLUTTER_RUST_BRIDGE_CODEGEN_CONTENT_HASH: i32 = -980625945;
...
fn wire__crate__api__simple__broadcast_tx_impl(
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_sync::<flutter_rust_bridge::for_generated::SseCodec, _>(
        ...
        move || {
            ...
            deserializer.end();
            transform_result_sse((move || crate::api::simple::broadcast_tx(api_tx))())
        },
    )
}
fn wire__crate__api__simple__change_birthday_impl(
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_sync::<flutter_rust_bridge::for_generated::SseCodec, _>(
        ...
        move || {
            ...
            deserializer.end();
            transform_result_sse((move || {
                crate::api::simple::change_birthday(api_encoded_wallet, api_birthday)
            })())
        },
    )
}
...
fn wire__crate__api__simple__create_new_psbt_impl(
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_sync::<flutter_rust_bridge::for_generated::SseCodec, _>(
        ...
        move || {
            ...
            deserializer.end();
            transform_result_sse((move || {
                crate::api::simple::create_new_psbt(api_encoded_wallet, api_inputs, api_recipients)
            })())
        },
    )
}
...
fn wire__crate__api__simple__get_wallet_info_impl(
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_sync::<flutter_rust_bridge::for_generated::SseCodec, _>(
        ...
        move || {
            ...
            deserializer.end();
            transform_result_sse((move || {
                crate::api::simple::get_wallet_info(api_encoded_wallet)
            })())
        },
    )
}
...
fn wire__crate__api__simple__mark_outpoints_spent_impl(
    ptr_: flutter_rust_bridge::for_generated::PlatformGeneralizedUint8ListPtr,
    rust_vec_len_: i32,
    data_len_: i32,
) -> flutter_rust_bridge::for_generated::WireSyncRust2DartSse {
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_sync::<flutter_rust_bridge::for_generated::SseCodec, _>(
        ...
        move || {
            ...
            deserializer.end();
            transform_result_sse((move || {
                crate::api::simple::mark_outpoints_spent(
                    api_encoded_wallet,
                    api_spent_by,
                    api_spent,
                )
...
fn wire__crate__api__simple__reset_wallet_impl(
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_sync::<flutter_rust_bridge::for_generated::SseCodec, _>(
        ...
        move || {
            ...
            deserializer.end();
            transform_result_sse((move || {
                crate::api::simple::reset_wallet(api_encoded_wallet)
            })())
        },
    )
}
        ...
        move || {
            ...
            move |context| async move {
                transform_result_sse((move || async move {
                         crate::api::simple::scan_to_tip(api_encoded_wallet).await
                    })().await)
            }
        },
    )
...
fn wire__crate__api__simple__show_mnemonic_impl(
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_sync::<flutter_rust_bridge::for_generated::SseCodec, _>(
        ...
        move || {
            ...
            deserializer.end();
            transform_result_sse((move || {
                crate::api::simple::show_mnemonic(api_encoded_wallet)
            })())
        },
    )
}
fn wire__crate__api__simple__sign_psbt_impl(
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_sync::<flutter_rust_bridge::for_generated::SseCodec, _>(
        ...
        move || {
            ...
            deserializer.end();
            transform_result_sse((move || {
                crate::api::simple::sign_psbt(api_encoded_wallet, api_psbt, api_finalize)
            })())
        },
    )
}
...
fn pde_ffi_dispatcher_primary_impl(
    ...
    match func_id {
        ...
        14 => wire__crate__api__simple__scan_to_tip_impl(port, ptr, rust_vec_len, data_len),
        15 => wire__crate__api__simple__setup_impl(port, ptr, rust_vec_len, data_len),
        18 => wire__crate__api__simple__sync_blockchain_impl(port, ptr, rust_vec_len, data_len),
        _ => unreachable!(),
    }
}
...
fn pde_ffi_dispatcher_sync_impl(
    ...
    match func_id {
        ...
        8 => wire__crate__api__simple__extract_tx_from_psbt_impl(ptr, rust_vec_len, data_len),
        9 => wire__crate__api__simple__fill_sp_outputs_impl(ptr, rust_vec_len, data_len),
        10 => wire__crate__api__simple__get_wallet_info_impl(ptr, rust_vec_len, data_len),
        12 => wire__crate__api__simple__mark_outpoints_spent_impl(ptr, rust_vec_len, data_len),
        13 => wire__crate__api__simple__reset_wallet_impl(ptr, rust_vec_len, data_len),
        16 => wire__crate__api__simple__show_mnemonic_impl(ptr, rust_vec_len, data_len),
        17 => wire__crate__api__simple__sign_psbt_impl(ptr, rust_vec_len, data_len),
        _ => unreachable!(),
    }
}
...
impl SseEncode for crate::api::simple::WalletStatus {
    ...
    fn sse_encode(self, serializer: &mut flutter_rust_bridge::for_generated::SseSerializer) {
        ...
        <std::collections::HashMap<String, crate::api::simple::OwnedOutput>>::sse_encode(
            self.outputs,
            serializer,
        );
    }
